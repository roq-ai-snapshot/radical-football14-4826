...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Academies', path: '/academies', entity: 'academy', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'Teams', path: '/teams', entity: 'team', service: AccessServiceEnum.PROJECT, icon: FiUsers },
  { name: 'Players', path: '/players', entity: 'player', service: AccessServiceEnum.PROJECT, icon: FiUser },
  {
